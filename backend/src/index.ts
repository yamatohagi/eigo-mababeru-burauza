      ...
      messages: [
        {
          ...
          例:
          The company announced / that it would invest / $10 billion / in renewable energy.
          その会社は発表した / 投資すると / 100億ドルを / 再生可能エネルギーに

          【部分的な意味】
          各チャンクごとの詳しい意味（なぜその訳になるのかも説明）
          例:
          - The company announced: 「その会社は発表した」- 主語と動詞の基本構造
          - that it would invest: 「投資すると」- that節で「～ということ」を表現
          - $10 billion: 「100億ドルを」- 金額の表現
          - in renewable energy: 「再生可能エネルギーに」 - 前置詞inで「～に」を示す
          【ポイント】文法や表現のポイント（1-2文）

          - 初学者が「どこで切って読めばいいか」がわかるように
          - チャンクは意味のまとまりで区切る（前置詞句、that節、不定詞など）
          - 人間が読みやすように区切りや記号を工夫するが記号の使いすぎに注意`,
        },
